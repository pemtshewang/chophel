      ...
      <main className="flex-1 overflow-y-auto pb-24">
        ...
        <section className="px-6 py-8 flex flex-col items-center border-b border-stone-100 dark:border-stone-800/50">
          <div className="relative mb-4">
            <div className="w-24 h-24 rounded-full bg-primary-gold flex items-center justify-center text-white text-4xl font-bold border-4 border-white dark:border-stone-800 shadow-lg overflow-hidden">
              <img
            ...
            {menuItems.map((item, index) => (
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-xl bg-stone-100 dark:bg-stone-800 flex items-center justify-center text-wood dark:text-primary-gold group-hover:bg-primary-crimson group-hover:text-white transition-colors">
        ...
        {/* Danger Zone */}
        <section className="py-4 mt-4 border-t border-stone-100 dark:border-stone-800/50">
